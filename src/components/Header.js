    ...
    return (
        <div className={`header__wrapper ${!showCategories && 'border-bottom'}`}>
            <div className="header">
                ...
                <img onClick={goToHomePage} src="https://i2.paste.pics/OUXAW.png" alt="" className="header__Logo" />
                ...
                <div className="header__right">
                    <div className="header__rightButtonWrapper">
                        <Button onClick={goToHomePage} size="small" className="header__rightButton" >Login</Button>
                        <Button size="small" className="header__rightButton" >Signup</Button>
                    </div>
